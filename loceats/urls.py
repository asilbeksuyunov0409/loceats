...
urlpatterns = [
    ...
    path('restaurant-admin/<int:restaurant_id>/invitations/<int:invitation_id>/accept/', views_html.accept_invitation, name='accept-invitation'),
    path('restaurant-admin/<int:restaurant_id>/invitations/<int:invitation_id>/decline/', views_html.decline_invitation, name='decline-invitation'),
